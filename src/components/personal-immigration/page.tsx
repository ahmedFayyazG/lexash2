    ...
    <>
      <div className="pageWrapper" ref={pageRef} onMouseMove={handleMouseMove}>
        ...
        <style>{`
          ...
          .services-nav-item:not(.active):hover {
            background: #f8f9fa;
          }
          .nav-icon {
          ...
          .services-nav-item.active .nav-title {
            color: #B9946A;
          }
        ...
        <section id="services" className="section">
            <div className="container">
                ...
                <div className="services-layout">
                    <nav className="services-nav animate-on-scroll">
                        {serviceCategories.map((category, index) => (
                            <div 
                                key={category.title} 
                                className={`services-nav-item ${activeCategory === index ? 'active' : ''}`}
                    ...
                    <div className="services-content-grid" key={animationKey}>
                        {serviceCategories[activeCategory].links.map((link, index) => (
                            <Link 
                                key={link.name} 
                                href={link.href} 
