...
const ContactArea = () => {
 ...
 <div className="col-12 col-md-6 col-lg-4">
  <div
    className="contact-info-card d-flex flex-column justify-content-between"
  ...
  >
    <div>
      ...
      <h4 style={{ fontFamily: 'Poppins, sans-serif' }}>
        ...
        {/* Email */}
        <div className="col-12 col-md-6 col-lg-4">
          <div className="contact-info-card d-flex flex-column justify-content-between" style={{ minHeight: '280px' }}>
            <div>
              <div className="icon-wrapper mb-3">
                {/* Email Icon */}
              ...
              <p className="mb-0" style={{ fontFamily: 'Poppins, sans-serif' }}>Email address</p>
            <h4 style={{ fontFamily: 'Poppins, sans-serif' }}>
  <a
        ...
        <div className="col-12 col-md-6 col-lg-4">
          <div className="contact-info-card d-flex flex-column justify-content-between" style={{ minHeight: '280px' }}>
            <div>
              ...
              <p className="mb-0" style={{ fontFamily: 'Poppins, sans-serif' }}>Office Address</p>
              <h4 style={{ fontFamily: 'Poppins, sans-serif' }}>
 ...
 <div
  ...
  style={{
    position: 'relative',
    paddingBottom: '40%', // Reduced height
    height: 0,
    overflow: 'hidden',
  }}
>
              ...
              <div className="col-12 col-lg-10">
                <div className="contact-form bg-secondary m-0 mt-0">
                  <div className="section-heading text-center">
                    <h2 style={{ fontFamily: 'Poppins, sans-serif',}}>Have Questions? <br  style={{ fontFamily: 'Poppins, sans-serif',}}/>Contact us!</h2>
                  </div>
