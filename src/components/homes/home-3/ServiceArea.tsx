...
const services = [
  ...
  },
  {
    ...
    icon: "BriefcaseBusiness", // Lucide icon
    content:
      "We offer strategic immigration solutions for UK businesses, entrepreneurs, and overseas investors. We advise on Skilled Worker Visas, Health and Care Worker Visas, Innovator Founder Visas, and support Sponsor Licence applications to ensure full Home Office compliance."
  },
  {
    title: "Will Writing (Including Islamic Wills)",
    icon: "ScrollText", // Lucide icon
    content:
      "We draft clear, legally sound wills tailored to your values and needs, including Shariah-compliant Islamic Wills. With fixed-fee pricing and confidential consultations, we help protect your legacy with simplicity and legal precision."
  },
  {
    title: "Self-Sponsorship",
    icon: "Building2", // Lucide icon
    content:
      "Self-sponsorship allows business owners to sponsor themselves through a UK company via the Skilled Worker visa route. We assist with business setup, Sponsor Licence applications, immigration compliance, and visa submissions—offering a path to permanent residence and citizenship."
  }
];
