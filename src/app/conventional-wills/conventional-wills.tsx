...
import { FileText, Users, Home, Gift, Shield } from 'lucide-react';
...
const keyElements: KeyElement[] = [
    { title: 'Appointment of Executors', description: 'Choose trusted individuals to carry out your wishes and manage your estate.', icon: <Users/> },
    { title: 'Distribution of Assets', description: 'Clearly state how your property, savings, and possessions should be distributed among your beneficiaries.', icon: <Home/> },
    { title: 'Guardianship for Children', description: 'Appoint legal guardians to care for your minor children, ensuring their well-being.', icon: <Shield/> },
    { title: 'Specific Gifts and Legacies', description: 'Leave specific items or sums of money to particular people or charities.', icon: <Gift/> },
];


// --- MAIN PAGE COMPONENT ---
const ConventionalWillsPage = () => {
      ...
      <div className="pageWrapper" ref={pageRef} onMouseMove={handleMouseMove}>
        ...
        <section className="hero-section">
          ...
          <div className="container">
            <div className="hero-content">
              <h1>Expert Guidance on Conventional Wills</h1>
              <p>
                Our specialist solicitors provide comprehensive support to ensure your will is legally sound, protecting your assets and your loved ones.
              </p>
            ...
            <div className="container">
                <div className="intro-grid">
                    <div className="intro-content animate-on-scroll">
                        <h2>What is a Conventional Will?</h2>
                        <p>A conventional will is a legally binding document that outlines your wishes for the distribution of your property and the care of any minor children. It ensures your assets are passed on to the people and organisations you choose. Without a will, the law decides how your estate is divided, which may not align with your wishes. Our expert team ensures your will is drafted with precision, providing peace of mind for you and your family.</p>
                        <Link href="#contact" className="cta-button" style={{marginTop: '1rem'}}>Contact Our Team</Link>
                    </div>
                    <div className="animate-on-scroll delay-1">
                        <img src="https://images.unsplash.com/photo-1542841841-6cc985354175?q=80&w=2070&auto=format&fit=crop" alt="A happy couple together" className="intro-image" />
                    </div>
                </div>
            </div>
        </section>

        <section id="elements" className="section bg-light">
            <div className="container">
                <div className="section-header animate-on-scroll">
                    <div className="subtitle">ESSENTIAL COMPONENTS</div>
                    <h2>Key Elements of a Legally Sound Will</h2>
                    <p>A comprehensive will is structured to cover all aspects of your estate, ensuring your wishes are carried out precisely as you intend.</p>
                </div>
                <div className="elements-grid">
                    {keyElements.map((item, index) => (
                        <div key={index} className="element-card animate-on-scroll" style={{transitionDelay: `${index * 0.1}s`}}>
        ...
        <section className="cta-section">
            <div className="container animate-on-scroll">
                ...
                <p>Our experienced solicitors are here to provide clear, compassionate advice on creating a legally robust will. Let us help you achieve peace of mind.</p>
...
export default ConventionalWillsPage;
