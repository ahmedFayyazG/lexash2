'use client';
import MissionArea from '@/components/homes/home/VideoArea';
...
const menu_data = [
  ...
  { 
    ...
    has_dropdown: true,
    sub_menus: [
        { title: 'Our Team', link: '/ourteam', has_inner_dropdown: false},
        { title: 'Our Mission', link: '/our-mission', has_inner_dropdown: false },
    ]
  },
  { title: 'Insights', link: '/news-and-insights', has_dropdown: false },
  { title: 'Join Our Team', link: '/JoinOurTeam', has_dropdown: false },
...
const OffCanvas = ({ setOpenCavas, openCanvas }: { setOpenCavas: (isOpen: boolean) => void; openCanvas: boolean; }) => {
...
const SearchArea = ({ setSearchOpen, isSearchOpen }: { setSearchOpen: (isOpen: boolean) => void; isSearchOpen: boolean; }) => {
...
interface HeaderOneProps {
  style_2?: boolean; // The prop causing the error. Make it optional.
}

// FIX: Update the component signature to accept the props
